...
class MyWidgetGraphM extends StatelessWidget {
  final BarTouchData barTouchData;
  final FlTitlesData titlesData;
  final FlBorderData borderData;
  final List<BarChartGroupData> barGroups;
  final int ref;
  const MyWidgetGraphM(
      {super.key,
...
class BarChartSampleM extends ConsumerStatefulWidget {
  const BarChartSampleM({super.key});

  @override
  BarChartSampleState createState() => BarChartSampleState();
}

class BarChartSampleState extends ConsumerState<BarChartSampleM> {
  @override
  Widget build(BuildContext context) {
  ...
  Widget geTitles(double value, TitleMeta meta) {
    ...
    String text;
    List<Masculino> bands = ref.watch(masculinosProvider);
